...
// *** -----------------------                                            ***
// *** DemoApp Demonstrates the Implementation of a JPA Single Table      ***
...
// *** This Demo will Illustrate how Java Inheritence can be Implemented  ***
// *** in a MySQL Relational Database using a Single Table Strategy.      ***
// ***                                                                    ***
// **************************************************************************
public class DemoApp {
	...
	public static void main(String[] args) {
		...
		System.out.println();
		System.out.println("*********************************************************");
		System.out.println("*** Demo #1 - JPA Inheritance Strategy (Single Table) ***");
		System.out.println("*********************************************************\n");

		EntityManagerFactory emf = Persistence.createEntityManagerFactory("jpa_inheritence_demo1");
		...
		// ***********************************************************
		// *** Persist (i.e. Insert) Each Object into the Database ***
		// ***********************************************************
		try {	
